...
for (var i = 0; i < art.length; i++)
{
    if(i == randno)
    {
        ...
        document.getElementById("Article1").innerHTML = "Article No : " + id ;
        document.getElementById("Article1").innerHTML = tittle ;
        document.getElementById("Article2").innerHTML = Article ;
        document.getElementById("Article3").innerHTML ="author name : " + Author ;
        document.getElementById("Article4").innerHTML = "published date : " + date ;
        document.getElementById("Article5").innerHTML = "published by : " + publishe ;
        // document.getElementById("publication").innerHTML = "publication house : " + publication ;
      }}}
setInterval(function(){validate(),disp()},1000);
